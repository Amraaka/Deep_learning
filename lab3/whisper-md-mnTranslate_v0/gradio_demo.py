...
def main() -> None:
    ...
    def transcribe(audio_path, task_name):
        ...
        with torch.no_grad():
            ids = model.generate(input_features, language=LANGUAGE, task=task_name)
    ...
    gr.Interface(
        ...
        outputs="text",
        title="Whisper Medium — Mongolian (transcribe + translate)",
